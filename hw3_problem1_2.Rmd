...
There are a total of 134 aisles. The item with the most order was fresh vegetables, 
with the order sum 150609 times.
```{r}
...
If you want to select more than one subject you can use the %in% operator.
...
combind the mutate with case_when or if_else
```{r}
instacart %>%
...
In 2002, there are 6 states with more than 7 times of observation, they are CT,FL,MA,NC,NJ,PA respectively.
In 2010, there are a total of 14 states with more than 7 times observation. 
